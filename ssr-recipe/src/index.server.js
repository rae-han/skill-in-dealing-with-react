...
const statsFile = path.resolve('./build/loadable-stats.json') // ssr
...
const serverRender = async (req, res, next) => {
  ...
  const extractor = new ChunkExtractor({statsFile}) // ssr
  ...
  store.dispatch(END) // ssr

  try {
    await sagaPromise; // ssr
  ...
  // res.send(createPage(root, stateScript)); // 클라이언트에게 결과물을 응답합니다. // ssr-
